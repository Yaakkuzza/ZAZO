...
NGame = {
	...
	GAME_SPEED_SECONDS = { 0.4, 0.2, 0.1, 0.025, 0.005 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NNavy = {
	...
	NAVAL_COMBAT_AIR_LOW_AA_TARGET_SCORE = 500,                           -- how much score factor from low AA guns (scales between 0->this number)
},
