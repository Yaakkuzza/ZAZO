...
NGame = {
	...
	LAG_DAYS_FOR_LOWER_SPEED = 72,					-- Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 240,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 0.6, 0.3, 0.15, 0.05, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDiplomacy = {
	...
	MIN_WARGOAL_JUSTIFY_COST = 2000.0,					-- It always takes atleast 10 days to justify a wargoal
	...
	BASE_STAGE_COUP_TOTAL_COST = 2000, 				-- Equipment consume factor for stage coup.
...
NCountry = {
	...
	REINFORCEMENT_MANPOWER_CHUNK = 1.0,				-- Chunk size of manpower reinforcement delivery, in % of total manpower needed by the template.
	...
	AIR_SCORE_MULTIPLIER = 0.0,						-- Based on number of planes (which is typically a lot).
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 64,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.08,        -- global damage modifier
	...
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 1.25, -- how many CAS/TAC can enter a combat depending on enemy width there
	...
	LAND_COMBAT_STR_ARMOR_DEFLECTION_FACTOR = 0.8, -- damage reduction if armor outclassing enemy
	LAND_COMBAT_ORG_ARMOR_DEFLECTION_FACTOR = 0.8, -- damage reduction if armor outclassing enemy
	LAND_COMBAT_COLLATERAL_FACTOR = 0.001,		   -- Factor to scale collateral damage to infra and forts with.
	...
	ENEMY_AIR_SUPERIORITY_DEFENSE_STEEPNESS = 200, -- how quickly defense approaches the max impact diminishing returns curve
	...
	UNIT_EXP_LEVELS = { 0.1, 0.3, 0.6, 0.9 },		-- Experience needed to progress to the next level
	...
	SLOWEST_SPEED = 4,
	REINFORCEMENT_REQUEST_MAX_WAITING_DAYS = 2,   -- Every X days the equipment will be sent, regardless if still didn't produced all that has been requested.
	REINFORCEMENT_REQUEST_DAYS_FREQUENCY = 1,	   -- How many days must pass until we may give another reinforcement request
	...
	ARMY_TRAINING_FUEL_MULT = 0.4,					-- fuel consumption ratio while training
...
NAir = {
	...
	COMBAT_DAMAGE_SCALE_CARRIER = 0.1,                    -- same as above but used inside naval combat for carrier battles
	...
	BASE_KAMIKAZE_DAMAGE = 1.0,                    				-- Base Kamikaze death rate
	BASE_KAMIKAZE_TARGETING = 10.0,			        		-- Kamikaze can't be a bad target
...
NNavy = {
	...
	COMBAT_CRITICAL_DAMAGE_MULT = 2.0,								-- Multiplier for the critical damage. Scaled down with the ship reliability.
	...
	REPAIR_AND_RETURN_PRIO_MEDIUM = 0.6,							-- % of total Strength. When below, navy will go to home base to repair.
	...
	EXPERIENCE_FACTOR_CONVOY_ATTACK = 0.02,
	...
	AMPHIBIOUS_LANDING_PENALTY = - 0,								-- amphibious landing penalty
	...
	MAX_POSITIONING_PENALTY_FROM_HIGHER_SHIP_RATIO					= 0.1,  -- maximum penalty to get from larger fleets
	...
	DAMAGE_PENALTY_ON_MINIMUM_POSITIONING 							= 0.1,	-- damage penalty at 0% positioning
	...
	DEPTH_CHARGES_HIT_PROFILE 										= 1.0,	-- hit profile for depth charges	
	...
	NAVAL_COMBAT_AIR_CAPITAL_TARGET_SCORE = 1,
	NAVAL_COMBAT_AIR_CARRIER_TARGET_SCORE = 1,
	NAVAL_COMBAT_AIR_CONVOY_TARGET_SCORE = 1,
	NAVAL_COMBAT_AIR_STRENGTH_TARGET_SCORE = 1,                         -- how much score factor from low health (scales between 0->this number)
	NAVAL_COMBAT_AIR_LOW_AA_TARGET_SCORE = 1,                           -- how much score factor from low AA guns (scales between 0->this number)
},
